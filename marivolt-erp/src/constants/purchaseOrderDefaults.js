/**
 * Commercial defaults and standard PO wording for the document UI.
 * Buyer header fields come from Company master (`buyerDefaultsFromCompany` in `../lib/companyBuyer.js`).
 */
