...
const storeDispatchLineSchema = new mongoose.Schema(
  {
    ...
    invoiceLineId: { type: mongoose.Schema.Types.ObjectId, default: null },
    ...
    invoiceQty: { type: Number, default: 0, min: 0 },
...
const storeDispatchSchema = new mongoose.Schema(
  {
    ...
    sourceDocumentType: { type: String, default: "SALES_INVOICE", trim: true },
