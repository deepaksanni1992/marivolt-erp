...
const quotationLineSchema = new mongoose.Schema(
  {
    ...
    modelMatchStatus: { type: String, default: "", trim: true, uppercase: true },
...
const quotationSchema = new mongoose.Schema(
  {
    ...
    /** Vessel or plant name — not ESN. Additive; existing quotations stay empty. */
    vesselPlant: { type: String, default: "", trim: true },
