...
const labelPrintJobSchema = new mongoose.Schema(
  {
    ...
    /** Frozen destination — later printer-profile edits must not reinterpret this job. */
    printerCode: { type: String, default: "", trim: true, uppercase: true },
    printerDisplayName: { type: String, default: "", trim: true },
