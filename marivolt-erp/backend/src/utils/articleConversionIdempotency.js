...
export const ARTICLE_CONVERSION_DELETE_BLOCKED = "ARTICLE_CONVERSION_DELETE_BLOCKED";
export const ARTICLE_CONVERSION_DELETED = "ARTICLE_CONVERSION_DELETED";

export const ARTICLE_CONVERSION_SOURCE_DOCUMENT_TYPE = "ARTICLE_STOCK_CONVERSION";
export const ARTICLE_CONVERSION_POSTED_DELETE_MESSAGE =
  "Posted Article Conversions cannot be deleted. Use Reverse Conversion instead.";
